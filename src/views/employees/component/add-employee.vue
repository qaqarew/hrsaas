  ...
  >
    ...
    <el-form ref="addEmploy" label-width="120px" :model="formData" :rules="rules">
      ...
      <el-form-item label="部门" prop="departmentName">
        ...
        <el-tree v-show="isShow" :data="treeData" :props="{label:'name'}" @node-click="selecNode" />
      </el-form-item>
...
import emlployeesEum from '@/api/constant/employees'
...
export default {
  ...
  data() {
    return {
      hireType: emlployeesEum.hireType,
      isShow: false,
      formData: {
        username: '',
        mobile: '',
